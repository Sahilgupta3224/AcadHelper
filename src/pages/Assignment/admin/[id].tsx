        ...
        <div>
          ...
          <div className="flex justify-between mb-6">
            <div className="flex flex-col">
              ...
              <p className="text-gray-700 font-bold p-2 w-[50vw]">
                Description: {assignment.description}
              </p>
            </div>
                  ...
                  {submissions.map((submission) => (
                    ...
                    >
                      ...
                      <TableCell align="center">
                        <a
                          onClick={() =>
                            router.push(`/Submission/${submission._id}`)
                          }
                          className="text-blue-500  cursor-pointer"
                        >
                          Submission Details
            ...
            <Dialog open={show} onClose={handleClose}>
              ...
              <DialogContent>
                ...
                <TextField
                  ...
                  margin="normal"
                  value={
                    editedassignment?.DueDate instanceof Date
                ...
                <TextField
                  ...
                  onChange={(e) =>
                    seteditedassignment((prev) => ({
                      ...prev!,
                      status: e.target.value as "Open" | "Closed" | "Graded",
                    }))
                  }
                >
